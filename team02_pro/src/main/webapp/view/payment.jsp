...
<body>
	...
	<div id="payment">
		<img alt="" src="../images/weston_jo.jpg" style="width : 1000px; height : 400px">
		<p><b>통일신라 호텔</b></p>
		<p>
			<a id="tag">조식포함</a>
			<a id="tag">엑스트라베드</a>
		...
		<div id="option">
			...
			<hr>
			<div style ="background-color : #f5f5f5; margin : 5px;">
				<p>객실 요금</p>
				<ul>
				...
				<div style="background-color : white; border : 1px solid black">
					<p><a>보유 포인트</a><a style="float : right; margin: 0px 10px;"><b>1,000,000원</b></a></p>
					<p><a>사용</a><button style="float : right; margin: 0px 10px;">전액 사용</button><a style="float : right">원</a><input type="text" style="float : right"></p>
				</div>
				<p>일반 결제</p>
				...
				<form>
					...
					<input type="radio" name="person" value="법인카드">법인카드
				</form>
				
				<br>
				<br>
				<div style = "text-align: center;">
					<button id="last"><b>결제하기</b></button>
				</div>
			</div>
		</div>
	</div>
